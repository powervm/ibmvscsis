...
/*
 * TODO: The sgl1 segment descriptor for NVMe devices would probably
 * be defined here as it is mentioned in the generic NVMe spec
 */
...
/*
 * Used in demo, for now used in API calls in nvme-fabrics.
 */
struct nvme_queue {
